<template>
  <div id="app">
    ...
    <div class="container card pt-2 mb-5 primario" style="max-width: 1000px">
      ...
      <!-- LEGENDA -->
      <div class="m-3">
        <strong style="font-size: 5vh; text-shadow: 1px 1px 2px mediumseagreen;"> CALCULA TU HUELLA DE CARBONO INSTITUCIONAL </strong>
      </div>
      ...
      <div class="container contenedor card p-5 mb-5">
        ...
        <div class="row">
          <div class="col" aling="center" >
            <strong class="titulo">LOCALIZACIÓN</strong>
          </div>
        </div>
        <hr style="width: 300px; margin-left: auto; margin-right: auto;"/>
        <div class="row m-2">
          <div class="col-6" style="">
            <span class="">Cantidad de empleados: </span>
          </div>
          <div class="col-3">
        ...
        <div class="row m-2">
          <div class="col-6" style="">
            <span class="">Sector económico : </span>
          </div>
          <div class="col-3">
            <input type="string" class="form-control" style="text-align: center;">
          </div>
        </div>
        ...
        <div class="row m-2" id="lamparas">
          ...
          <div class="row p-2" id="btns-lampara">
            <div class="col-6">
              <button type="button" class="btn btn-success" @click="setLampara1">
                Agregar
              </button>
            </div>
            <div class="col-6">
      ...
      <div class="container contenedor card p-5 mb-5">
        ...
        <div class="row">
          <div class="col" aling="center">
            <strong class="titulo">PAPEL</strong>
          </div>
        </div>
        <hr style="width: 300px; margin-left: auto; margin-right: auto;" />
        ...
        <div class="row m-2" id="alimentos">
          <div class="row">
            <div class="col-6">
              <strong class="subtitulos">TIPO DE PAPEL</strong>
            </div>
            <div class="col-6">
              <strong class="subtitulos">UNIDADES SEMANALES</strong>
            </div>
          </div>
          ...
          <div class="row p-2" id="alimento" hidden>
            <div class="col-6">
              <select class="form-select" >
                <option selected hidden>  Tipo de papel </option>
